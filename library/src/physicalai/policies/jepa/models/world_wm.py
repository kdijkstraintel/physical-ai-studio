...
class VideoWM(nn.Module):
    ...
    def optimization_step(self):
        raise RuntimeError("Removed code of optimization_step")
        # """
        # Copy-paste from TrainableModel class
        # """
    ...
    def compute_energy_landscape(
        ...
        raise RuntimeError("Removed code of compute_energy_landscape")
...
def plot_energy_landscape(
    ...
    raise RuntimeError("Removed code of plot_energy_landscape")
