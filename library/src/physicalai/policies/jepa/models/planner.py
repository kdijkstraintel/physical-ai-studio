...
from physicalai.policies.jepa.models.objectives import BaseMPCObjective


def _lazy_import_nevergrad() -> tuple:
    """Lazy import nevergrad to reduce initial load time.

    Returns:
        Tuple containing (NgIohTuned,
                          NGOpt,
                          CMA,
                          ParametrizedCMA,
                          DiagonalCMA,
    ...
    """
    try:
        from nevergrad.optimizers import (NgIohTuned,
                                          NGOpt,
                                          CMA,
                                          ParametrizedCMA,
                                          DiagonalCMA,
                                          ...
                                          OnePlusOne,
                                          TwoPointsDE,)
        from nevergrad.p import Array
    except ImportError as e:
        msg = "jepa requires nevergrad library.\n\nInstall with:\n    uv pip install nevergrad"
...
class Planner(ABC):
    ...
    def set_objective(self, objective: BaseMPCObjective):
